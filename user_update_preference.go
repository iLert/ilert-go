...
func (c *Client) CreateUserUpdatePreference(input *CreateUserUpdatePreferenceInput) (*CreateUserUpdatePreferenceOutput, error) {
	...
	contact := &UserUpdatePreference{}
	err = json.Unmarshal(resp.Body(), contact)
	if err != nil {
		return nil, err
	}

	return &CreateUserUpdatePreferenceOutput{UserUpdatePreference: contact}, nil
}
...
func (c *Client) GetUserUpdatePreference(input *GetUserUpdatePreferenceInput) (*GetUserUpdatePreferenceOutput, error) {
	...
	return &GetUserUpdatePreferenceOutput{UserUpdatePreference: contact}, nil
}
...
func (c *Client) GetUserUpdatePreferences(input *GetUserUpdatePreferencesInput) (*GetUserUpdatePreferencesOutput, error) {
	...
	contacts := make([]*UserUpdatePreference, 0)
	err = json.Unmarshal(resp.Body(), &contacts)
	if err != nil {
		return nil, err
	}

	return &GetUserUpdatePreferencesOutput{UserUpdatePreferences: contacts}, nil
}
...
func (c *Client) UpdateUserUpdatePreference(input *UpdateUserUpdatePreferenceInput) (*UpdateUserUpdatePreferenceOutput, error) {
	...
	user := &UserUpdatePreference{}
	err = json.Unmarshal(resp.Body(), user)
	if err != nil {
		return nil, err
	}

	return &UpdateUserUpdatePreferenceOutput{UserUpdatePreference: user}, nil
}
