...
func (c *Client) CreateUserAlertPreference(input *CreateUserAlertPreferenceInput) (*CreateUserAlertPreferenceOutput, error) {
	...
	contact := &UserAlertPreference{}
	err = json.Unmarshal(resp.Body(), contact)
	if err != nil {
		return nil, err
	}

	return &CreateUserAlertPreferenceOutput{UserAlertPreference: contact}, nil
}
...
func (c *Client) GetUserAlertPreference(input *GetUserAlertPreferenceInput) (*GetUserAlertPreferenceOutput, error) {
	...
	return &GetUserAlertPreferenceOutput{UserAlertPreference: contact}, nil
}
...
func (c *Client) GetUserAlertPreferences(input *GetUserAlertPreferencesInput) (*GetUserAlertPreferencesOutput, error) {
	...
	contacts := make([]*UserAlertPreference, 0)
	err = json.Unmarshal(resp.Body(), &contacts)
	if err != nil {
		return nil, err
	}

	return &GetUserAlertPreferencesOutput{UserAlertPreferences: contacts}, nil
}
...
func (c *Client) UpdateUserAlertPreference(input *UpdateUserAlertPreferenceInput) (*UpdateUserAlertPreferenceOutput, error) {
	...
	return &UpdateUserAlertPreferenceOutput{UserAlertPreference: user}, nil
}
